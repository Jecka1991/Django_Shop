# Generated by Django 3.2.5 on 2021-10-29 14:36
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mainapp', '0010_alter_product_category'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filter_measure', models.CharField(help_text='Единица измерения для конкретного фильтра.Например "Длина лески (м)". Единицей измерения будет информация в скобках.', max_length=50, verbose_name='Единица измерения для фильтра')),
