...
class ProductFeatures(models.Model):
    ...
    feature_key = models.CharField(max_length=255, verbose_name='Наименование характеристики')
    category = models.ForeignKey(Category, verbose_name='Категория', on_delete=models.CASCADE)
    ...
    filter_measure = models.CharField(
        ...
        help_text='Единица измерения для конкретного фильтра.'
                  'Например "Длина лески (м)". Единицей измерения будет информация в скобках.'
    )
